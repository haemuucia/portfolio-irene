          ...
          >
            ...
            >
              <div className="bg-white dark:bg-[#1c1c1c] rounded-2xl overflow-hidden p-4">
                <Image
                  src="/assets/images/irendiugm.jpg"
...
<motion.div
  ...
  className="text-white text-lg leading-relaxed w-full md:w-1/2 max-w-xl"
>
  ...
  <p className="mb-4">
    ...
    , an enthusiastic IT student with a deep love for AI, Web Development,
    and Database Management. I've always been passionate about crafting
    unique and helpful solutions that blend smart technology and interactive
    design.
  </p>

  <p className="mb-4">
    I'm currently studying Informatics at President University, with Artificial Intelligence as my concentration.
    I'm actively exploring how AI can solve real-world problems through several ongoing projects. Whether
    it’s building or developing a website or training AI models, I’m always eager to learn and grow.
  </p>

  <p>
    I'm open to meaningful collaborations and excited to keep learning while shaping the future of tech with passionate people.
    Let’s connect and build something amazing together!
        ...
        <motion.div
          ...
          className="mt-24"
        >
        <h2 className="text-4ml md:text-5xl font-extrabold mb-10 text-center bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-yellow-300 hover:to-pink-400 bg-clip-text text-transparent transition-all duration-500">
          Education Journey
        </h2>

          <div className="relative flex flex-col gap-32 items-center">
            <div className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-blue-400 via-purple-400 to-pink-400 rounded-full"></div>
                ...
                >
                  <div className="flex flex-col items-end text-right">
                    ...
                    <p className="mt-2 text-base text-white/90 max-w-sm">
                      ...
                      <br/>
                      ○ Relevant Courses: Data Structures and Algorithms, Computer Vision, Natural Language Processing, Understanding, and Generating, Image Processing and Recognition, Web and Server Side Programming, Database
                    </p>
                  </div>
                </motion.div>
              </div>
